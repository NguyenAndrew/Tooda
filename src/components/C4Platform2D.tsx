...
import HealthcarePlatform2D from './HealthcarePlatform2D';
...
export default function C4Platform2D({ allNodes, allConnections, initialExample, level }: Props) {
